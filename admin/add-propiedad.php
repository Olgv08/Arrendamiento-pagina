        ...
        <div class="contenedor-principal">
            <div id="nueva-propiedad">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="fila">
                        <div class="box">
                            <label for="habitaciones">Refrigeracion</label>
                            <select name="habitaciones" id="" class="input-entrada-texto">
                        ...
                        <div class="box">
                            <label for="pisos">Estacionamientos</label>
