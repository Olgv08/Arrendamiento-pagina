            ...
            <div class="info-publicacion">
                ...
                <section class="descripcion">
                    ...
                    <div class="fila">
                        ...
                        <div class="dato">
                            <span class="header">Refrigeracion</span>
                ...
                <section class="compartir">
                    ...
                    <a href="http://facebook.com/sharer.php?u=http://localhost/rebod/publicacion.php?idPublicacion=<?php echo $propiedad['id'] ?>" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
